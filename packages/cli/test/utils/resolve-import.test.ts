...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/code100x/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/code100x/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/code100x/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/code100x/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/code100x/Projects/foobar/lib/utils")
})
