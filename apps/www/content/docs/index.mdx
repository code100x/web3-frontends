...
You can use any framework that supports React. [Next.js](https://ui.code100x.com/docs/installation/next), [Astro](https://ui.code100x.com/docs/installation/astro), [Remix](https://ui.code100x.com/docs/installation/remix), [Gatsby](https://ui.code100x.com/docs/installation/gatsby) etc.
